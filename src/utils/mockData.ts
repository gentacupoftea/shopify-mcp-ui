...
export const mockOrders = [
  ...
  },
  {
    ...
    totalAmount: 32000,
    items: [{ id: "3", name: "スマートウォッチ", quantity: 1, price: 32000 }],
...
export const mockChatMessages = [
  ...
  },
  {
    ...
    message:
      "現在の在庫状況をお調べします。ワイヤレスイヤホン Proは145個、スマートウォッチ Xは67個の在庫があります。",
  ...
  },
  {
    ...
    message:
      "4月の売上データをお見せします。総売上は￥12,567,890、注文数は489件、平均注文額は￥25,730でした。",
